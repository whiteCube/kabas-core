...
{   
   ...
   {
       $data = File::loadJson(__DIR__ . '/../Mocking/content/en-GB/partials/footer.json');
       $this->assertEquals('footer', $data->id);
   }
   ...
   public function throws_exception_if_loading_an_invalid_json_file()
   {
       ...
       File::loadJson(__DIR__ . '/../Mocking/invalid.json');
   }
   ...
   {
       $this->assertTrue(File::isJson(__DIR__ . '/../Mocking/invalid.json'));
       $this->assertFalse(File::isJson(__DIR__ . '/../Mocking/gulpfile.js'));
   }
