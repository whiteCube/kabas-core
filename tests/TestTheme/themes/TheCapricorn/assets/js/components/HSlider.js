...
class HSlider {
    ...
    setConf() {
        this.conf = {
            modifierActive: 'hSlider--active',
            modifierAnim: 'hSlider--anim',
            list: 'hSlider__list',

            item: 'hSliderItem',
            itemLeft: 'hSliderItem--left',
            itemRight: 'hSliderItem--right',
            itemActive: 'hSliderItem--active',
            itemHidden: 'hSliderItem--hidden',
            itemAnim: 'hSliderItem--anim',
